...
class SqueezeNetShallow(nn.Module):

    def __init__(self):
        super(SqueezeNetShallow, self).__init__()

        self.N_STEPS = 10
        self.metadata_size = (11, 20)
        self.pre_metadata_features = nn.Sequential(
            nn.Conv2d(ARGS.nframes * 6, 64, kernel_size=12, padding=4, stride=2),
        ...
        final_conv = nn.Conv2d(256, self.N_STEPS * 4, kernel_size=1)
