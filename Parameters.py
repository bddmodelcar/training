...
parser.add_argument('--bkup', default=None, type=str, help='Path to' +
                    ' resume file containing network state dictionary')
parser.add_argument('--save-path', default='save/all_no_Smyth/', type=str, help='Path to' +
...
parser.add_argument('--require-one', default=('campus','local','Tilden'), type=str, nargs='+',
